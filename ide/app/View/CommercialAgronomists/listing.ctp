...
$this->Html->addCrumb(__('CommercialAgronomist'), '#');
$this->Html->addCrumb(__('List All'), '/CommercialAgronomists/listing');
 ?>
    ...
    <div class="row">
        ...
        <div class="panel panel-primary">
            <div class="panel-heading">
                    <h4><?php echo __('List All CommercialAgronomist') ?></h4>
                    <div class="options">
                        <span>
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                    <thead>
                        <tr>
                            ...
                            <th><?php echo $this->Paginator->sort('ca_code',__('Code')) ?>
                            </th>
                    ...
                    <tbody>  
                        ...
                        <tr class="<?php echo ($key%2)==0?'event':'odd' ?>">
                            <td><?php echo $this->MyHtml->checkBox($value['CommercialAgronomist']['ca_code'],$key)?></td>
                            ...
                            <!--<a href="#" class="btn btn-xs btn-success">-->
                                ...
                                <?php
                                echo $this->MyHtml->deleteButton($value['CommercialAgronomist']['ca_code']);
                                ?>
                            </td>
