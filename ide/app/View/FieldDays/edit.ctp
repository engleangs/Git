...
$this->Html->addCrumb(__('Add New'), '/FieldDays/edit'.$data['FieldDay']['field_day_id']);
...
<div class="container">
    <div class="row">
        <form id="adminForm"
        data-validate="parsley" action="<?php echo $this->Html->url(array('action'=>'save',$data['FieldDay']['field_day_id']));?>" class="form-horizontal row-border" method="post">     
            <div class="panel panel-midnightblue">
                <div class="panel-heading">
                   <h4> <?php echo __('Edit FieldDay') ?></h4>           
                </div>
                <div class="panel-body collapse in">
                    <input type="hidden" name="field_day_id" value="<?php echo $data['FieldDay']['field_day_id'] ?>">
                    <div class="form-group">
                        <label class="col-sm-3 control-label">
                            <?php echo __('Field Date') ?><span class="require">*</span>
                        </label>
                        <div class="col-sm-4">
                        <input type="text" required="required" value="<?php echo $data['FieldDay']['field_day_date'] ?>" readonly="readonly" name="field_day_date" id="datepicker" class="form-control" placeholder="<?php echo __('Date placeholder') ?>">
                        </div>
                        <div class="error"></div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                        <input type="text" value ="<?php echo $data['FieldDay']['field_day_subject'] ?>" required="required" name="field_day_subject"  class="form-control" placeholder="<?php echo __('Subject placeholder') ?>">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" value="<?php echo $data['FieldDay']['responsible_staff'] ?>" required="required" name="responsible_staff"  class="form-control" placeholder="<?php echo __('Responsible Staff placeholder') ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" required="required" class="form-control" value="<?php echo $data['FieldDay']['type_of_events'] ?>" placeholder="<?php echo __('Type of Event placeholder') ?>"  name="type_of_events" class="col-sm-12">
                        </div>
                    </div>
                </div>
