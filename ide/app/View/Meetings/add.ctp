...
$this->Html->addCrumb(__('Add New'), '/Meetings/add');
        ...
        data-validate="parsley" action="<?php echo $this->Html->url(array('action'=>'save'));?>" class="form-horizontal row-border" method="post">     
            <div class="panel panel-midnightblue">
                <div class="panel-heading">
                   <h4> <?php echo __('Add New Meeting') ?></h4>           
                </div>
                <div class="panel-body collapse in">
                    <div class="form-group">
                        <label class="col-sm-4 control-label">
                            <?php echo __('Meeting Date') ?><span class="require">*</span>
                        </label>
                        <div class="col-sm-4">
                        <input type="text" required="required" value="<?php echo date('Y-m-d') ?>" readonly="readonly" name="meeting_date" id="datepicker" class="form-control" placeholder="<?php echo __('Date placeholder ') ?>">
                        </div>
                        <div class="error"></div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" required="required" name="meeting_subject"  class="form-control" placeholder="<?php echo __('meeting subject placeholder') ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" required="required" name="meeting_responsible_staff"  class="form-control" placeholder="<?php echo __('Responsible Staff placeholder') ?>">
