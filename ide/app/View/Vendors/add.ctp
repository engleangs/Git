...
$this->Html->addCrumb(__('Add New'), '/Vendors/add');
 ?>
        ...
        data-validate="parsley" action="<?php echo $this->Html->url(array('action'=>'save'));?>" class="form-horizontal row-border" method="post" enctype="multipart/form-data">    
    	    <div class="panel panel-midnightblue">
    	        <div class="panel-heading">
	               <h4> <?php echo __('Add New Vendor') ?></h4>	        
    	        </div>
    	        <div class="panel-body collapse in">
                    <div class="col-sm-7" style="float:left;" >
                        <legend><?php echo __('Add New Vendor')?></legend>
                        <fieldset>
                            <div class="panel-body ">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" required="required" name="vendor_code" 
                                        id="vendor_code" class="form-control" placeholder="<?php echo __('Code placeholder') ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" required="required" name="vendor_name_en"class="form-control" placeholder="<?php echo __('Name English placeholder') ?>">
                                    </div>
                                </div>     
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" name="vendor_name_kh" class="form-control" placeholder="<?php echo __('Name Khmer placeholder') ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="radio block">
                                            <label><input type="radio" name="vendor_gender" value="Female"> <?php echo __("Female")?><label>
                                        </div>
                                        <div class="radio block">
                                            <label><input type="radio" value="Male" name="vendor_gender" checked><?php echo __("Male")?></label>
                                        </div>
                                    </div>
                                </div>  
                                <div class="form-group">
                                ...
                                <div class="form-group" id="branch_manager_block">
                                    ...
                                    <div class="col-sm-6">
                                        <select name="branch_manager" id="branch_manager" class="col-sm-12">
                                            <option value="Lim Naluch">Lim Naluch (Kampot)</option>
                                            <option value="Tek Monorom">Tek Monorom (Takeo)</option>
                                            <option value="Om Sopheap">Om Sopheap (Prey Veng)</option>
                                            <option value="Chan Sarom">Chan Sarom (Svay Rieng)</option>
                                            <option value="Mov Kiman"> Mov Kiman (Kandal)</option>
                                            <option value="Sieng Vansitha">Sieng Vansitha</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" value="<?php echo date('Y-m-d') ?>" readonly="readonly" name="vendor_date_of_birth" id="datepicker2" class="form-control" placeholder="<?php echo __('Date of birth placeholder') ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" name="vendor_phone" required="required" class="form-control" placeholder="<?php echo __('Phone placeholder') ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">
                                        <?php echo __('Email') ?><span class="require">*</span>
                                    </label>
                                    <div class="col-sm-6">
                                        <input type="email" name="vendor_email" required="required" class="form-control" placeholder="<?php echo __('Email placeholder') ?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" name="vendor_datestarted" required="required" class="form-control" id="datepicker" readonly="readonly" value="<?php echo date('Y-m-d');?>" 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" required="required" name="vendor_date_ended" class="form-control" id="datepicker_branch" readonly="readonly" value="<?php echo date('Y-m-d');?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">
                    ...
                    <div class="col-sm-5" style="float:left;" id="client_info_block" >
                        ...
                        <div class="row">
                            <div class="col-sm-6 col-sm-offset-3">
                                <div class="btn-toolbar">
                                    ...
                                    id="save" title="<?php echo __('Save Title') ?>"><?php echo __('Save') ?>
                                    </button>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#client_info_block').hide();
        $('#ca_block').hide();
       changePosition();
        $('#vendor_code').on('change',function(){
            checkExistingVendorCode();
        });
        function checkExistingVendorCode()
        {
            $.ajax({
                url:'<?php echo $this->Html->url(array("controller"=>"Vendors","action"=>"checkExistingVendorCode")) ?>',
                type: 'POST',
                data:{
