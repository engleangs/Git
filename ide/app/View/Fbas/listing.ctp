...
$this->Html->addCrumb(__('FBA'), '#');
$this->Html->addCrumb(__('List All'), '/Fbas/listing');
 ?>
    ...
    <div class="row">
        ...
        <div class="panel panel-primary">
            <div class="panel-heading">
                    <h4><?php echo __('List All FBA') ?></h4>
                    <div class="options">
                        <span>
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                    <thead>
                        <tr>
                            ...
                            <th><?php echo $this->Paginator->sort('fba_code',__('Code')) ?></th>
                            <th><?php echo $this->Paginator->sort('ca_code',__('CA'))?></th>
                    ...
                    <tbody>  
                        ...
                        <tr class="<?php echo ($key%2)==0?'event':'odd' ?>">
                            <td><?php echo $this->MyHtml->checkBox($value['Fba']['fba_code'],$key)?></td>
                            <td><?php echo $value['Fba']['fba_code']?></td>
                            <td><?php echo $value['CommercialAgronomist']['ca_code']?></td>
                            <td><?php echo $value['CommercialAgronomist']['created_by']?></td>
                            <td><?php echo $value['CommercialAgronomist']['modified_by']?></td>
                                                       
                            <td>
                            <!--<a href="#" class="btn btn-xs btn-success">-->
                                <?php 
                                                                        
                                    echo $this->MyHtml->editButton($value['Fba']['fba_code']);
                                
                                ?>
                                &nbsp;
                                <?php
                                echo $this->MyHtml->deleteButton($value['Fba']['fba_code']);
                                ?>
                            </td>
