...
$this->Html->addCrumb(__('RiceWeek'), '#');
$this->Html->addCrumb(__('List All'), '/RiceWeeks/listing');
 ?>
    ...
    <div class="row">
        ...
        <div class="panel panel-primary">
                <div class="panel-heading">
                    <h4><?php echo __('List All RiceWeek') ?></h4>
                    <div class="options">
                        <span>
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" class="table table-overflow table-striped table-bordered" id="example">
                            <thead>
                                <tr>
                                    ...
                                    <th width="5%"><?php echo $this->Paginator->sort('week',__('Week')) ?></th>
                            ...
                            <tbody>  
                                ...
                                <tr class="<?php echo ($key%2)==0?'event':'odd' ?>">
                                    <td><?php echo $this->MyHtml->checkBox($value['RiceWeek']['riceweek_id'],$key) ?></td>
                                    <td><?php echo @$value['RiceWeek']['week']?></td>
                                    <td><?php echo @$value['RiceWeek']['week_date']?></td>
                                    <td><?php echo @$value['RiceWeek']['week_trainer']?></td>
                                    <td><?php echo @$value['RiceWeek']['week_topic1']?></td>
                                    <td><?php echo @$value['RiceWeek']['week_topic2']?></td>
                                    <td><?php echo @$value['RiceWeek']['week_topic3']?></td>
                                    <td><?php echo @$value['RiceWeek']['week_topic4']?></td>
                                    <td><?php echo @($value['RiceWeek']['week_client_attend']?'Yes':'No')?></td>
                                    <td>
                                        <?php echo @$value['RiceWeek']['training_id']
                                        .' ('.$value['Training']['training_datestart']
                                        .' , '.
                                            $value['Training']['training_datefinish'] .')'?>
                                    </td>
                                    <td><?php echo $value['RiceWeek']['created_by']?></td>
                                    <td><?php echo $value['RiceWeek']['modified_by']?></td>
                                    <td>
                                    <!--<a href="#" class="btn btn-xs btn-success">-->
                                        <?php 
                                                                                
                                            echo $this->MyHtml->editButton($value['RiceWeek']['riceweek_id']);
                                        
                                        ?>
                                        &nbsp;
                                        <?php
                                        echo $this->MyHtml->deleteButton($value['RiceWeek']['riceweek_id']);
                                        ?>
                                    </td>
