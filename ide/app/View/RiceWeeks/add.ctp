...
$this->Html->addCrumb(__('Add New'), '/RiceWeeks/add');
        ...
        data-validate="parsley" action="<?php echo $this->Html->url(array('action'=>'save'));?>" class="form-horizontal row-border" method="post"> 
            <div class="panel-body collapse in">
                    <div class="col-sm-5" style="float:left;" >
                        <legend><?php echo __('Add Rice Week')?></legend>
                        <fieldset>
                             <div class="valid"></div>
                             <div class="panel-body ">
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">
                                        <?php echo __('Training') ?><span class="required">*</span>
                                    </label>
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">
                                        <?php echo __('Week_#') ?><span class="required">*</span>
                                    </label>
                                    <div class="col-sm-8">
                                ...
                                <div class="form-group">
                                        <label class="col-sm-3 control-label"><?php echo __('Week Trainer') ?><span class="required">*</span>
                                        </label>
                                        <div class="col-sm-8">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">
                                        <?php echo __('Topic 1') ?><span class="required">*</span>
                                    </label>
                                    <div class="col-sm-8" class="form-control">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">
                                        <?php echo __('Topic 2') ?><span class="required">*</span>
                                    </label>
                                    <div class="col-sm-8" class="form-control">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">
                                        <?php echo __('Topic 3') ?><span class="required">*</span>
                                    </label>
                                    <div class="col-sm-8" class="form-control">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">
                                        <?php echo __('Topic 4') ?><span class="required">*</span>
                                    </label>
                                    <div class="col-sm-8" class="form-control">
...
<script type="text/javascript">
    $(document).ready(function(){
      ...
      function checkValidWeek()
      {
           ...
           if(week < 1 || week > 8)
           {
                $('.valid').html('<div class="alert alert-dismissable alert-danger ">Invalid Week, Must be 1 -> 8</div>');
           }
           else
           {
                $('.valid').html('');
