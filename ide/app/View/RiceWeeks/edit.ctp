...
$this->Html->addCrumb(__('RiceWeek'), '/RiceWeeks/listing');
$this->Html->addCrumb(__('Edit RiceWeek'), '/RiceWeeks/edit'.$data['RiceWeek']['riceweek_id']);
?>
<div id="page-heading"></div>
<div class="container">
    <div class="row">
        <form id="adminForm"
        data-validate="parsley" action="<?php echo $this->Html->url(array('action'=>'save',$data['RiceWeek']['riceweek_id']));?>" class="form-horizontal row-border" method="post">     
            <div class="panel panel-midnightblue">
                <div class="panel-heading">
                   <h4> <?php echo __('Edit Rice Week') ?></h4>           
                </div>
                <div class="panel-body collapse in">

                    <div class="col-sm-5" style="float:left;" >
                        <legend><?php echo __('Edit Rice Week')?></legend>
                        <fieldset>
                            <div class="panel-body ">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8" class="form-control">
                                        ...
                                        readonly="readonly" class="form-control" value="<?php echo $data['RiceWeek']['training_id']?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" required="required" readonly="readonly" id="week" value="<?php echo $data['RiceWeek']['week'] ?>" name="week" class="form-control" placeholder="<?php echo __('Week placeholder') ?>">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" required="required" value="<?php echo $data['RiceWeek']['week_date'] ?>" readonly="readonly" name="week_date" class="form-control" id="datepicker" value="<?php echo date('Y-m-d') ?>">
                                    </div>
                                </div>     
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" required="required" value="<?php echo $data['RiceWeek']['week_trainer'] ?>" name="week_trainer" class="form-control" placeholder="<?php echo __('Week Trainer placeholder') ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">
                                    ...
                                    <div class="col-sm-8" class="form-control">
                                        ...
                                        <?php foreach ($topics as $key => $value) {
                                          ?>
                                          <option 
                                          <?php if($value['Topic']['topic']==$data['RiceWeek']['week_topic1']) 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8" class="form-control">
                                        ...
                                        <?php foreach ($topics as $key => $value) {
                                          ?>
                                          <option <?php if($value['Topic']['topic']==$data['RiceWeek']['week_topic2']) echo 'selected="selected"' ?> value="<?php echo $value['Topic']['topic']?>">
                                            <?php echo $value['Topic']['topic'] ?>
                                          </option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8" class="form-control">
                                        ...
                                        <?php foreach ($topics as $key => $value) {
                                          ?>
                                          <option <?php if($value['Topic']['topic']==$data['RiceWeek']['week_topic3']) echo 'selected="selected"' ?> value="<?php echo $value['Topic']['topic']?>">
                                            <?php echo $value['Topic']['topic'] ?>
                                          </option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8" class="form-control">
                                        ...
                                        <?php foreach ($topics as $key => $value) {
                                          ?>
                                          <option <?php if($value['Topic']['topic']==$data['RiceWeek']['week_topic4']) echo 'selected="selected"' ?> value="<?php echo $value['Topic']['topic']?>">
                                            <?php echo $value['Topic']['topic'] ?>
                                          </option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8" class="form-control">
                                        <select name="week_client_attend" id="select-nonclient" class="col-sm-12"> 
                                            <option <?php  if($data['RiceWeek']['week_client_attend']==1) echo 'selected="selected"'; ?> value=1>Yes</option>
                                            <option <?php if($data['RiceWeek']['week_client_attend']==0) echo 'selected="selected"'; ?> value=0>No</option> 
                                        </select>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-sm-7" style="float:left;" >
                        <legend><?php echo __('Rice Weeks Training')?></legend>
                        <fieldset>
...
<script type="text/javascript">
    $(document).ready(function(){
      ...
      function selectRiceWeekByTraining()
      {
            $.ajax({
            url:'<?php echo $this->Html->url(array("controller"=>"RiceWeeks","action"=>"getRiceWeekByTraining")) ?>',
            type: 'POST',
            data: {
