                                 ...
                                 ?>
                                    <tr class="td-client">
                                        ...
                                        <td width="100px"
                                         ...
                                         style="border:none;">
                                            <div class="hide-show">
                                            <?php  echo $this->MyHtml->deleteDetail($client['clientTrainingId'],$value['training_id']);
                                            ?>
                                            <div>
                                         </td>
                                    </tr>
                                ...
                                foreach ($value['NonClients'] as $nonclient) { ?>
                                    <tr class="td-client">
                                        ...
                                        <td width="100px"  style="border:none;">
                                            <div class="hide-show">
                                            <?php  echo $this->MyHtml->deleteDetail($nonclient['clientTrainingId'],$value['training_id']);
                                            ?>
                                            </div>
                                         </td>
                                    </tr>
                            ...
                            <td>
                                ...
                                foreach ($value['Vendors'] as $vendor) { ?>
                                    <tr class="td-client">
                                        ...
                                        <td width="100px"  style="border:none;">
                                            <div class="hide-show">
                                            <?php  echo $this->MyHtml->deleteDetail($vendor['clientTrainingId'],$value['training_id']);
                                            ?>
                                            </div>
                                         </td>
                                    </tr>
