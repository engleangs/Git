...
$this->Html->addCrumb(__('Add New'), '/Projects/edit'.$data['Project']['project_id']);
...
<div class="container">
    <div class="row">
        <form id="adminForm"
        data-validate="parsley" action="<?php echo $this->Html->url(array('action'=>'save',$data['Project']['project_id']));?>" class="form-horizontal row-border" method="post">     
            <div class="panel panel-midnightblue">
                ...
                <div class="panel-body collapse in">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" required="required" value="<?php echo $data['Project']['project_name_en'] ?>" name="project_name_en" class="form-control" placeholder="<?php echo __('Name English placeholder') ?>"> 
                        </div>
                    </div>
                    <!-- <div class="form-group">
                        <label class="col-sm-3 control-label">
                        ...
                        <div class="col-sm-4">
                            <select name="client_id" id="select-client" class="col-sm-12">
                                ...
                                <option 
<?php if($data['Project']['client_id']==$value['Client']['client_id'])echo 'selected="selected"'?> 
        value="<?php echo $value['Client']['client_id'] ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <select name="fba_code" id="select-fba" class="col-sm-12">
                                ...
                                <option <?php if($data['Project']['fba_code']==$value['Fba']['fba_code']) echo 'selected="selected"'?> value="<?php echo $value['Fba']['fba_code'] ?>">
