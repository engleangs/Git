...
$this->Html->addCrumb(__('Project'), '#');
$this->Html->addCrumb(__('List All'), '/Projects/listing');
        ...
        <form action="<?php echo $this->Html->url(array()) ?>" id="adminForm" method="post">
    	    <div class="panel panel-primary">
                <div class="panel-heading">
                    <h4><?php echo __('List All Project') ?></h4>
                    <div class="options">
                        <span>
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example"><!--datatables-->
                        <thead>
                            <tr>
                                ...
                                <th><?php echo $this->Paginator->sort('project_id',__('Code')) ?></th>
                                <th><?php echo $this->Paginator->sort('project_name_en',__('Project Name'))?>
                                </th>
                               <!--  <th><?php echo $this->Paginator->sort('client_id',__('Client'))?>
                                </th>
                                <th><?php echo $this->Paginator->sort('fba_code',__('FBA Code'))?></th> -->
                        ...
                        <tbody>  
                            ...
                            <tr class="<?php echo ($key%2)==0?'event':'odd' ?>">
                                <td><?php echo $this->MyHtml->checkBox($value['Project']['project_id'],$key) ?></td>
                                <td><?php echo $value['Project']['project_id']?></td>
                                <td><?php echo $value['Project']['project_name_en']?>
                                </td>
                               <!--  <td><?php echo $value['Project']['client_id'].' ( '.$value['Client']['client_name_en'].' )';?></td>
                                <td><?php echo $value['Project']['fba_code']?>
                                </td> -->
                                <td><?php echo $value['Project']['created_by']?></td>
                                <td><?php echo $value['Project']['modified_by']?></td>
                                <td>
                                
                                <!--<a href="#" class="btn btn-xs btn-success">-->
                                    <?php 
                                                                            
                                        echo $this->MyHtml->editButton($value['Project']['project_id']);
                                    
                                    ?>
                                    &nbsp;
                                    <?php
                                    echo $this->MyHtml->deleteButton($value['Project']['project_id']);
                                    ?>
                                </td>
