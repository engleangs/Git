...
$this->Html->addCrumb(__('NonClient'), '#');
$this->Html->addCrumb(__('List Detail'), '/NonClients/listing');

 ?>
<div id="page-heading"></div>
<div class="container">
    <div class="row">
        <form action="<?php echo $this->Html->url(array('action'=>'save',$data[0]['c']['nonclient_id']));?>" method="POST" id="adminForm">
        <div class="panel panel-primary">
            <div class="panel-heading">
                    <h4><?php echo __('Detail NonClient') ?></h4>
                    <div class="options">
                        <span>
                            ...
                            <td>
                                <table class="detail-info" >
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $value['c']['nonclient_id']?></td>
                                    </tr>
                                    <tr>
                                        <td><?php echo __('Name') ?> :</td>
                                        <td><?php echo $value['c']['nonclient_name_en']?></td>
                                    </tr>
                                    <tr>
                                        <td><?php echo __('Khmer Name') ?> :</td>
                                        <td><?php echo $value['c']['nonclient_name_kh']?></td>
                                    </tr>
                                    <tr>
                                        <td><?php echo __('Gender') ?> :</td>
                                        <td><?php echo $value['c']['nonclient_gender']?></td>
                                    </tr>
                                    <tr>
                                        <td><?php echo __('Phone') ?> :</td>
                                        <td><?php echo $value['c']['nonclient_phone']?></td>
                                    </tr>
                                    <tr>
                                        <td><?php echo __('Date of birth') ?> :</td>
                                        <td><?php echo $value['c']['nonclient_date_of_birth']?></td>
                                    </tr>
