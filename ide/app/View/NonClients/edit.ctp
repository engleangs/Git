...
<div class="container">
    <div class="row">
        <form id="adminForm"
        data-validate="parsley" action="<?php echo $this->Html->url(array('action'=>'save',$data['NonClient']['nonclient_id']));?>" class="form-horizontal row-border" method="POST">
            <div class="panel panel-midnightblue">
                ...
                <div class="panel-body collapse in">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                                <input type="text" required="required" readonly="readonly" value="<?php echo $data['NonClient']['nonclient_id']?>" name="nonclient_id" class="form-control" placeholder="<?php echo __('Code placeholder') ?>">
                        </div>
                    </div>     
                            <div class="form-group">
                                <label class="col-sm-3 control-label">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" required="required" value="<?php echo $data['NonClient']['nonclient_name_en'] ?>" name="nonclient_name_en" class="form-control" placeholder="<?php echo __('Name English placeholder') ?>">
                                </div>
                            </div>     
                            <div class="form-group">
                                <label class="col-sm-3 control-label">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" required="required" value="<?php echo $data['NonClient']['nonclient_phone'] ?>" name="nonclient_phone" class="form-control" placeholder="<?php echo __('Phone placeholder') ?>">
                                </div>
                            </div>                            
                        <div class="form-group">
                            <div class="col-sm-5">
    ...
    value="<?php echo $data['NonClient']['phum_code'] ?>">
        </form>
     </div>
</div>
