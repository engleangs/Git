...
$this->Html->addCrumb(__('Add New'), '/Trainings/add');
        ...
        data-validate="parsley" action="<?php echo $this->Html->url(array('action'=>'save'));?>" class="form-horizontal row-border" method="post">     
            <div class="panel panel-midnightblue">
                <div class="panel-heading">
                   <h4> <?php echo __('Add New Training') ?></h4>           
                </div>
                <div class="panel-body collapse in">
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                        <input type="text" required="required" value="<?php echo date('Y-m-d') ?>" readonly="readonly" name="training_datestart" id="datepicker" class="form-control" placeholder="<?php echo __('Date placeholder ') ?>">
                        </div>
                        <div class="error"></div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                        <input type="text" required="required" value="<?php echo date('Y-m-d') ?>" readonly="readonly" name="training_datefinish" id="datepicker2" class="form-control" placeholder="<?php echo __('Date placeholder') ?>">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" required="required" name="training_responsible_staff"  class="form-control" placeholder="<?php echo __('Responsible Staff placeholder') ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4" class="form-control">
                            ...
                            <?php
                                ...
                                {
                            ?>
                                <option value="<?php echo $value['Crop']['crop_code'] ?>">
