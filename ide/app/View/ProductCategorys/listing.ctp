...
$this->Html->addCrumb(__('ProductCategory'), '#');
$this->Html->addCrumb(__('List All'), '/ProductCategorys/listing');
 ?>
    ...
    <div class="row">
        ...
        <div class="panel panel-primary">
            <div class="panel-heading">
                    <h4><?php echo __('List All ProductCategory') ?></h4>
                    <div class="options">
                        <span>
                ...
                <div class="panel-body collapse in">
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example"><!--datatables-->
                        <thead>
                            <tr>
                                <th width="3%"><input type="checkbox" class="checkAll" /></th>
                                <th><?php echo $this->Paginator->sort('productcategory_code',__('Code')) ?></th>
                                <th><?php echo $this->Paginator->sort('productcategory_name_en',__('Name English'))?></th>
                                <th><?php echo $this->Paginator->sort('productcategory_name_kh',__('Name Khmer'))?></th>
                        ...
                        <tbody>  
                            ...
                            <tr class="<?php echo ($key%2)==0?'event':'odd' ?>">
                                <td><?php echo $this->MyHtml->checkBox($value['ProductCategory']['productcategory_code'],$key) ?></td>
                                <td><?php echo $value['ProductCategory']['productcategory_code']?></td>
                                <td><?php echo $value['ProductCategory']['productcategory_name_en']?></td>
                                <td><?php echo $value['ProductCategory']['productcategory_name_kh']?></td>
                                <td><?php echo $value['ProductCategory']['created_by']?></td>
                                <td><?php echo $value['ProductCategory']['modified_by']?>
                                </td>
                                <td>
                                <!--<a href="#" class="btn btn-xs btn-success">-->
                                    <?php 
                                                                            
                                        echo $this->MyHtml->editButton($value['ProductCategory']['productcategory_code']);
                                    
                                    ?>
                                    &nbsp;
                                    <?php
                                    echo $this->MyHtml->deleteButton($value['ProductCategory']['productcategory_code']);
                                    ?>
                                </td>
