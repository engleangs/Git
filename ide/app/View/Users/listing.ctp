...
$this->Html->addCrumb(__('List All'), '/Users/listing');
 ?>
    ...
    <div class="row">
        ...
        <div class="panel panel-primary">
                <div class="panel-heading">
                    <h4><?php echo __('List All User') ?></h4>
                    <div class="options">
                        <span>
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                        <thead>
                            <tr>
                                ...
                                <th><?php echo $this->Paginator->sort('user_id',__('Code')) ?></th>
                                <th><?php echo $this->Paginator->sort('user_name_en',__('Name English'))?></th>
                                <th><?php echo $this->Paginator->sort('user_name_kh',__('Name Khmer'))?></th>
                                <th>
                                    <?php echo $this->Paginator->sort('user_permission',__('Permission'))?></th>
                                </th>
                                <th>
                                    <?php echo $this->Paginator->sort('user_username',__('Username'))?></th>
                                </th>
                        ...
                        <tbody>  
                            ...
                            <tr class="<?php echo ($key%2)==0?'event':'odd' ?>">
                                <td><?php echo $this->MyHtml->checkBox($value['User']['user_id'],$key) ?></td>
                                <td><?php echo $value['User']['user_id']?></td>
                                <td><?php echo $value['User']['user_name_en']?></td>
                                <td><?php echo $value['User']['user_name_kh']?></td>
                                <td><?php echo $value['User']['user_permission']?></td>
                                <td><?php echo $value['User']['user_username']?></td>
                                <td><?php echo $value['User']['created_by']?></td>
                                <td><?php echo $value['User']['modified_by']?></td>
                                <td>
                                <!--<a href="#" class="btn btn-xs btn-success">-->
                                    <?php 
                                                                            
                                        echo $this->MyHtml->editButton($value['User']['user_id']);
                                    
                                    ?>
                                    &nbsp;
                                    <?php
                                    echo $this->MyHtml->deleteButton($value['User']['user_id']);
                                    ?>
                                </td>
