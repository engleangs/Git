...
$this->Html->addCrumb(__('Labor'), '#');
$this->Html->addCrumb(__('List All'), '/Labors/listing');
 ?>
    ...
    <div class="row">
        ...
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h4><?php echo __('List All Labor') ?></h4>
                    <div class="options">
                        <span>
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                    <thead>
                        <tr>
                            ...
                            <th><?php echo $this->Paginator->sort('labor_code',__('Code')) ?></th>
                            <th><?php echo $this->Paginator->sort('labor_name_en',__('Name English'))?></th>
                            <th><?php echo $this->Paginator->sort('labor_name_kh',__('Name Khmer'))?>
                            </th>
                            <th><?php echo $this->Paginator->sort('labor_unit',__('Unit'))?>
                            </th>
                            <th><?php echo $this->Paginator->sort('labor_costper_unit_usd',__('Cost per Unit').' ($)')?>
                            </th>
                    ...
                    <tbody>  
                        ...
                        <tr class="<?php echo ($key%2)==0?'event':'odd' ?>">
                            <td><?php echo $this->MyHtml->checkBox($value['Labor']['labor_code'],$key) ?></td>
                            <td><?php echo $value['Labor']['labor_code']?></td>
                            <td><?php echo $value['Labor']['labor_name_en']?></td>
                            <td><?php echo $value['Labor']['labor_name_kh']?></td>
                            <td><?php echo $value['Labor']['labor_unit']?></td>
                            <td><?php echo $value['Labor']['labor_costper_unit_usd']?></td>
                            <td><?php echo $value['Labor']['created_by']?></td>
                            <td><?php echo $value['Labor']['modified_by']?></td>
                            
                            <td>
                            <!--<a href="#" class="btn btn-xs btn-success">-->
                                <?php 
                                                                        
                                    echo $this->MyHtml->editButton($value['Labor']['labor_code']);
                                
                                ?>
                                &nbsp;
                                <?php
                                echo $this->MyHtml->deleteButton($value['Labor']['labor_code']);
                                ?>
                            </td>
