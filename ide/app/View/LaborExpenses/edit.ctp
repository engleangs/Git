...
$this->Html->addCrumb(__('Labor Expense'), '/LaborExpenses/listing');
$this->Html->addCrumb(__('Edit LaborExpense'), '/LaborExpenses/edit'.$data['LaborExpense']['laborexpense_id']);
...
<div class="container">
    <div class="row">
        <form id="adminForm"
        data-validate="parsley" action="<?php echo $this->Html->url(array('action'=>'save',$data['LaborExpense']['laborexpense_id']));?>" class="form-horizontal row-border" method="post">     
            <div class="panel panel-midnightblue">
                <div class="panel-heading">
                   <h4> <?php echo __('Edit Labor Expense') ?></h4>           
                </div>
                        ...
                        <fieldset>
                            <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" required="required" name="laborexpense_id" class="form-control" readonly="readonly" value="<?php echo $data['LaborExpense']['laborexpense_id'] ?>" 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" name="laborexpense_date" required="required" class="form-control" id="datepicker" readonly="readonly" value="<?php echo $data['LaborExpense']['laborexpense_date']?>" 
                                    ...
                                    <div class ="form-group">
                                        ...
                                        <div class="col-sm-6">
                                           <input type="text" required="required" value="<?php echo $data['LaborExpense']['laborexpense_quantity'] ?>" id="quantity" name="laborexpense_quantity" class="form-control" placeholder ="<?php echo __('Quantity placeholder')?>"/>
                    ...
                    <div class="panel-footer">
                            <div class="row">
                                <div class="col-sm-6 col-sm-offset-3">
                                    <div onclick="return validate(this.Form)" class="btn-toolbar">
