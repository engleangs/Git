...
$this->Html->addCrumb(__('VegetableHarvestDemo'), '#');
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="table table-report table-striped table-bordered" id="example">
                    <thead>
                        <tr>
                            ...
                            <th><?php echo __('Harvest Date')?></th>
                            <th><?php echo __('Seed($)')?></th>
                            <th><?php echo __('Fertiliser($)')?></th>
                            <th><?php echo __('Pest Control($)')?></th>
                            <th><?php echo __('Fuel($) ')?></th>
                            <th><?php echo __('Total Materials Costs ($)')?></th>
                            <th><?php echo __('Total Labor Costs ($)')?></th>
                            <th><?php echo __('Total Costs (Materials + Labor) ($)')?></th>
                            <th><?php echo __('Total Crop yield in KG')?></th>
                            <th><?php echo __('Crops KG keep for consumption')?></th>
                            <th><?php echo __('Total crop KG for sale')?></th>
                            <th><?php echo __('Selling price $/KG')?></th>
                            <th><?php echo __('TOTAL GROSS INCOME (Total crop yield multiplies the selling pric $)(AA*AD)')?></th>
                            <th><?php echo __('Gross income from crop sale $(AC*AD)')?></th>
                            <th><?php echo __('TOTAL NET INCOME $ (AE-Z)')?></th>
                            <th><?php echo __('Net income from crop sale $ (AF-Z)')?> </th>                                  
                        </tr>
                    </thead>
                    <tbody>  
