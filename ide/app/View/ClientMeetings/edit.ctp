...
$this->Html->addCrumb(__('Edit'), '/NonClients/edit'.$data['NonClient']['nonclient_id']);
 ?>
<div id="page-heading"></div>
<div class="container">
    <div class="row">
        <form action="<?php echo $this->Html->url(array('action'=>'save',$data['NonClient']['nonclient_id']));?>" class="form-horizontal row-border" method="POST">
            <div class="panel panel-midnightblue">
                <div class="panel-heading">
                    <h4> <?php echo __('Edit Non Client') ?></h4>            
                </div>
            ...
            <div class="col-sm-6" style="float:left;" >
                ...
                <fieldset>
                    ...
                    <div class="col-sm-6">
                        <input type="text" readonly="readonly" value="<?php echo $data['NonClient']['nonclient_id']?>" name="nonclient_id" class="form-control" placeholder="<?php echo __('Code placeholder') ?>">
                    </div>
                            </div>     
                            <div class="form-group">
                                <label class="col-sm-3 control-label">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" value="<?php echo $data['NonClient']['nonclient_name_en'] ?>" name="nonclient_name_en" class="form-control" placeholder="<?php echo __('Name English placeholder') ?>">
                                </div>
                            </div>     
                            <div class="form-group">
                                <label class="col-sm-3 control-label">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" value="<?php echo $data['NonClient']['nonclient_name_kh']  ?>" name="nonclient_name_kh" class="form-control" placeholder="<?php echo __('Name Khmer placeholder') ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">
                                ...
                                <div class="col-sm-6" class="form-control">
                                    ...
                                    <?php
                                        ...
                                        {
                                        ?>
<option <?php if($data['NonClient']['phum_code']==$value['Phum']['phum_code']) echo 'select="select"';?> value="<?php echo $value['Phum']['phum_code'] ?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                        <div class="radio block">
                                            <label>
                                            <input type="radio" value="Female" <?php if($data['NonClient']['nonclient_gender']=='Female') echo "checked='checked'"; ?>  name="nonclient_gender"> 
                                            <?php echo __("Female")?><label>
                                        </div>
                                        <div class="radio block">
                                            <label><input type="radio" value="Male" <?php if($data['NonClient']['nonclient_gender']=='Male')echo "checked='checked'"; ?> name="nonclient_gender" ><?php echo __("Male")?></label>
                                        </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" value="<?php echo $data['NonClient']['nonclient_date_of_birth'] ?>" name="nonclient_date_of_birth" class="form-control" id="datepicker2" readonly="readonly"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" value="<?php echo $data['NonClient']['nonclient_phone'] ?>" name="nonclient_phone" class="form-control" placeholder="<?php echo __('Phone placeholder') ?>">
                                </div>
                            </div>                            
