                    ...
                    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                        <thead>
                            <tr>
                                ...
                                <th><?php echo $this->Paginator->sort('srok_code',__('Code')) ?></th>
                                <th><?php echo $this->Paginator->sort('srok_name_en',__('Name English'))?></th>
                                <th><?php echo $this->Paginator->sort('srok_name_kh',__('Name Khmer'))?></th>
                                <th>
                                    <?php echo $this->Paginator->sort('khet_code',__('Khet'))?></th>
                                </th>
                                <th>
                                    <?php echo __('Action') ?>                                          
                                </th>
                        ...
                        <tbody>  
                            ...
                            <tr class="<?php echo ($key%2)==0?'event':'odd' ?>">
                                <td><?php echo $this->MyHtml->checkBox($value['Srok']['srok_code'],$key) ?></td>
                                <td><?php echo $value['Srok']['srok_code']?></td>
                                <td><?php echo $value['Srok']['srok_name_en']?></td>
                                <td><?php echo $value['Srok']['srok_name_kh']?></td>
                                <td><?php echo $value['Khet']['khet_name_en'].' : '.$value['Khet']['khet_code'];?></td>
                                <td>
                                <!--<a href="#" class="btn btn-xs btn-success">-->
                                    <?php 
                                                                            
                                        echo $this->MyHtml->editButton($value['Srok']['srok_code']);
                                    
                                    ?>
                                    &nbsp;
                                    <?php
                                    echo $this->MyHtml->deleteButton($value['Srok']['srok_code']);
                                    ?>
                                </td>
