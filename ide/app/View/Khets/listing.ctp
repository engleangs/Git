...
$this->Html->addCrumb(__('Khet'), '#');
$this->Html->addCrumb(__('List All'), '/Khets/listing');
 ?>
        ...
        <form action="<?php echo $this->Html->url(array()) ?>" id="adminForm" method="post">
    	    <div class="panel panel-primary">
                <div class="panel-heading">
                    <h4><?php echo __('List All Khet') ?></h4>
                    <div class="options">
                        <span>
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example"><!--datatables-->
                        <thead>
                            <tr>
                                ...
                                <th><?php echo $this->Paginator->sort('khet_code',__('Code')) ?></th>
                                <th><?php echo $this->Paginator->sort('khet_name_en',__('Name English'))?></th>
                                <th><?php echo $this->Paginator->sort('khet_name_kh',__('Name Khmer'))?></th>
                                <th>
                                    <?php echo __('Action') ?>                                        	
                                </th>
                        ...
                        <tbody>  
                            ...
                            <tr class="<?php echo ($key%2)==0?'event':'odd' ?>">
                                <td><?php echo $this->MyHtml->checkBox($value['Khet']['khet_code'],$key) ?></td>
                                <td><?php echo $value['Khet']['khet_code']?></td>
                                <td><?php echo $value['Khet']['khet_name_en']?></td>
                                <td><?php echo $value['Khet']['khet_name_kh']?></td>
                                <td>
                                <!--<a href="#" class="btn btn-xs btn-success">-->
                                    <?php 
                                                                            
                                        echo $this->MyHtml->editButton($value['Khet']['khet_code']);
                                    
                                    ?>
                                    &nbsp;
                                    <?php
                                    echo $this->MyHtml->deleteButton($value['Khet']['khet_code']);
                                    ?>
                                </td>
