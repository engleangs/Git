...
$this->Html->addCrumb(__('topic'), '#');
$this->Html->addCrumb(__('List All'), '/Topics/listing');
 ?>
    ...
    <div class="row">
    	...
    	<div class="panel panel-primary">
            <div class="panel-heading">
                    <h4><?php echo __('List All Topic') ?></h4>
                    <div class="options">
                        <span>
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                    <thead>
                        <tr>
                            ...
                            <th><?php echo $this->Paginator->sort('topic_id',__('Code')) ?></th>
                            <th><?php echo $this->Paginator->sort('topic',__('Topic'))?></th>
                    ...
                    <tbody>  
                        ...
                        <tr class="<?php echo ($key%2)==0?'event':'odd' ?>">
                            <td><?php echo $this->MyHtml->checkBox($value['Topic']['topic_id'],$key) ?></td>
                            <td><?php echo @$value['Topic']['topic_id']?></td>
                            <td><?php echo @$value['Topic']['topic']?></td>
                            <td>
                                <?php echo (@$value['Topic']['type']=='vegetabletopic'?'Vegetable Topic':'Rice Topic') ?></td>
                            
                            <td>
                            <!--<a href="#" class="btn btn-xs btn-success">-->
                                <?php 
                                                                        
                                    echo $this->MyHtml->editButton($value['Topic']['topic_id']);
                                
                                ?>
                                &nbsp;
                                <?php
                                echo $this->MyHtml->deleteButton($value['Topic']['topic_id']);
                                ?>
                            </td>
