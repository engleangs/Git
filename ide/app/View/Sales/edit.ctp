...
$this->Html->addCrumb(__('Edit'), '/Sales/edit'.$data['Sale']['sale_id']);
...
<div class="container">
    <div class="row">
        <form id="adminForm"
        data-validate="parsley" action="<?php echo $this->Html->url(array('action'=>'save',$data['Sale']['sale_id']));?>" class="form-horizontal row-border" method="post">     
            <div class="panel panel-midnightblue">
                <div class="panel-heading">
                   <h4> <?php echo __('Edit Sale') ?></h4>           
                </div>
                        ...
                        <fieldset>
                            <div class="panel-body ">
                                <div class ="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" required="required" name="sale_date" class="form-control" id="datepicker" readonly="readonly" value="<?php echo $data['Sale']['sale_date'];?>" 
                                ...
                                <div class ="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <select name="vendor_code"  id="select-vendor" class="col-sm-12">
                                            ...
                                            ?>
                                                <option <?php if($vendorclientsales[0]['VendorClientSale']['vendor_code']==$value['Vendor']['vendor_code']) echo 'selected="selected"'?> value='<?php echo $value['Vendor']['vendor_code'] ?>'>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" value="<?php echo $data['Sale']['sale_value_usd']?>" required="required" name="sale_value_usd" class="form-control" placeholder="<?php echo __('Transaction Total placeholder') ?>">
                                    </div>
                                    <div class="col-sm-2">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <textarea name="sale_comment" cols="30" class="form-control" rows="5"><?php echo $data['Sale']['sale_comment'] ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </fieldset>
       ...
       <input type="hidden" value="<?php echo $vendorclientsales[0]['VendorClientSale']['client_id'] ?>" id="hidden_client_id">          
    </form>
</div>
</div>
...
<script type="text/javascript">
    ...
    {
            $.ajax({
            url:'<?php echo $this->Html->url(array("controller"=>"Vendors","action"=>"getClientBelongToVendor")) ?>'+"/"+$('#hidden_client_id').val(),
            type: 'POST',
            dataType :'json',
            data: {
                vendor_code: $('#select-vendor').val()
